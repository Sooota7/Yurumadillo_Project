...
////------------------------------------------------------
////終了
//void PLAYER::Player_Finalize(void)
//{
//	//テクスチャの解放
//	for(int i=0;i<4;i++)
//	{
...
//		StateCount++;	//カウンターインクリメント
//		if (StateCount >= 60)	//適当に待つ
//		{
//			State = PIECE_STATE::PIECE_STATE_IDLE;
//			StateCount = 0;
//		
//			//ブロック消去チェック
//			Block_EraseBlock();
...
////------------------------------------------------------
////描画
//void PLAYER::Player_Draw(void)
//{
//
//	if (State != PIECE_STATE_MOVE)
//	{	//落下中でなければ表示はしない
//		return;
//	}
//
...
//		//テクスチャの設定
//		g_pContext->PSSetShaderResources(0, 1, &g_Texture[Type[i]]);
//		//ブレンド無し
...
//
////新しいブロックを作る
//void PLAYER::Player_Create()
//{
//	//出現座標
//	Position = { BLOCK_WIDTH * 2.5f, -BLOCK_HEIGHT * 2.5f };//とりあえず
//
//	//ブロックを３つ決める
//	for (int i = 0; i < 3; i++)
//	{
//		Type[i] = rand() % 4;	//4種類から1つ選ぶ
//	}
//
//	//ゲームオーバーチェック
...
//	{	//ブロックがあったらミスモードへ移行	
//		State = PIECE_STATE::PIECE_STATE_MISS_IDLE;
//		StateCount = 0;
//	}
//	else
//	{
//		State = PIECE_STATE::PIECE_STATE_MOVE;	//移動モード
//		StateCount = 0;//カウンターリセット
//	}
//
//
//	//State = PIECE_STATE::PIECE_STATE_MOVE;	//移動モード
...
//			Block_SetBlock(x, y, Type[i]);
//		}
//
//		State = PIECE_STATE::PIECE_STATE_GROUND_IDLE;//着地した
//
//	}
//
//	//加速処理
...
//	{
//		Position.y += 5.0f;	//速度は適当に調節する
//	}
//	//通常の落下処理
//	Position.y += 2.0f * 0.2f;	//速度は適当に調節する
//
//}
